...
Hooks
Django provides 3 hooks to class based middleware. [check for more](https://youtube.com/playlist?list=PLbw9kI1cQpMrPWG55DmMLEZvRpmldlXMH&si=FHSflLKo29EgGCoA)
